...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.5, 447.0, 201.0, 22.0 ],
					"style" : "",
					"text_width" : 150.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.5, 478.12207, 201.0, 22.0 ],
					"style" : "",
					"text_width" : 150.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.5, 510.244202, 201.0, 22.0 ],
					"style" : "",
					"text_width" : 150.0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 85.166664, 12.0, 30.0, 23.0 ],
									"style" : "",
									"text" : "in 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.25, 445.0, 30.0, 23.0 ],
									"style" : "",
									"text" : "in 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 8.499992, 445.0, 30.0, 23.0 ],
									"style" : "",
									"text" : "in 1"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "param drywet 0.1 @min 0 @max 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 102.75, 278.666656, 206.0, 23.0 ],
									"style" : "",
									"text" : "param damping 0.15 @min 0 @max 1"
								}
...
,
					"patching_rect" : [ 37.0, 500.0, 44.0, 23.0 ],
					"style" : "",
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.5, 540.366333, 201.0, 22.0 ],
					"style" : "",
					"text_width" : 150.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.5, 571.488403, 201.0, 22.0 ],
					"style" : "",
					"text_width" : 150.0
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 37.0, 395.0, 72.0, 79.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 180.0, 103.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 824.0, 472.0, 80.5, 22.0 ],
					"style" : "",
					"text" : "2 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 885.5, 426.0, 39.0, 32.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 850.5, 377.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 885.5, 378.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "== 10"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 850.5, 340.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "ctlin"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 85.0, 124.0, 39.0, 32.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 85.0, 76.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "== 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 50.0, 38.0, 147.0, 22.0 ],
					"style" : "",
					"text" : "notein @name \"to Max 1\""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 540.0, 255.0, 136.0, 42.0 ],
					"presentation_rect" : [ 617.190369, 497.0, 50.0, 28.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 232.0, 128.0, 107.0, 22.0 ],
									"style" : "",
									"text" : "36. 0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 55.0, 66.0, 89.0, 22.0 ],
									"style" : "",
									"text" : "unpack 0. 100."
								}
...
,
					"patching_rect" : [ 809.5, 2.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 440.5, 34.0, 467.0, 196.0 ],
						...
						"snapshot" : 						{
							...
							"valuedictionary" : 							{
								"parameter_values" : 								{
									...
									"kick-sweep" : 7.0,
									"kick-tune" : 129.0,
									"ophat-decay" : 2224.488281,
									"snare-decay" : 976.417297,
									"snare-hicut" : 700.0,
									"snare-level" : 50.0,
									"snare-snap" : 82.0,
									"snare-tune" : 262.598419,
									"tom-decay" : 269.842529,
									"tom-hi" : 450.0,
									"tom-level" : 64.0,
									"tom-low" : 100.0,
									"tom-mid" : 200.0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 37.0, 354.5, 224.0, 23.0 ],
					"style" : "",
					"text" : "poly~ poly.waveguide_string 12 @steal 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 563.244202, 44.0, 44.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.809631, 314.5, 64.0, 22.0 ],
					"style" : "",
					"text" : "allnotesoff"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 8.0, 197.0, 22.0 ],
					"style" : ""
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/code/workshop_nime_2017",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
